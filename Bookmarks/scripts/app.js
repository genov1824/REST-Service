...
(function () {
    ...
    function addBookmarkError(error){
        showErrorMessage("Bookmark created failed.")
    }
    ...
    function deleteBookmark(sessionToken, bookmark){
        ajaxRequester.deleteBookmark(sessionToken, bookmark.objectId, showBookmarksView, deleteBookmarkError);
    }

    function deleteBookmarkError(error){
        showErrorMessage("Bookmark deleted failed.")
    }
